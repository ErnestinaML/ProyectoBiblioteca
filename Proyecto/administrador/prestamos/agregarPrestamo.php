                ...
                <form method="POST" action="procesar_prestamo.php">
                    ...
                    <fieldset class="border rounded p-3 mb-3">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Número de Usuario <span class="text-danger">*</span></label>
                                <input type="text" name="num_usuario" class="form-control" placeholder="RFC o No. Control" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Carrera / División <span class="text-danger">*</span></label>
                                <input type="text" name="carrera" class="form-control" placeholder="Carrera o División" required>
                            </div>
                        </div>
                    </fieldset>
